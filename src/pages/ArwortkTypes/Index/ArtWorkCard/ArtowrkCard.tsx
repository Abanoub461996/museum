  ...
  const {
    ...
    queryFn: async () => {
      return await axiosInstance.get(
        `/artworks/search?query[term][artwork_type_id]=${type.id}&limit=13&fields=id,title,image_id,artwork_type_title,date_display,thumbnail,artist_title,place_of_origin,color`
      );
    },
    select: (res) => {
